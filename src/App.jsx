...
const CARDS = {
  ...
  "Scryb Ranger":          { type:"creature", cmc:2, tags:["combo","elf","untap","ranger","flash"], tapsFor:0 , devotion:1, greenPips:1},
  "Wirewood Symbiote":     { type:"creature", cmc:1, tags:["combo","elf","untap","symbiote"], tapsFor:0 , devotion:1, greenPips:1},
  // BIG MANA DORKS
  ...
  "Hyrax Tower Scout":     { type:"creature", cmc:3, tags:["combo","scout","untap","human"] , devotion:1, greenPips:1},
  ...
  "Misty Rainforest":      { type:"land", cmc:0, tags:["land","fetch","fetch-forest"] , devotion:0},
  "Verdant Catacombs":     { type:"land", cmc:0, tags:["land","fetch","fetch-forest"] , devotion:0},
  "Windswept Heath":       { type:"land", cmc:0, tags:["land","fetch","fetch-forest"] , devotion:0},
  "Wooded Foothills":      { type:"land", cmc:0, tags:["land","fetch","fetch-forest"] , devotion:0},
  ...
  // ACCELERANTS
  "Sol Ring":              { type:"artifact", cmc:1, tags:["rock","fast-mana"] , devotion:0, greenPips:0},
  "Chrome Mox":            { type:"artifact", cmc:0, tags:["rock","fast-mana","mox"] , devotion:0, greenPips:0},
  "Mox Diamond":           { type:"artifact", cmc:0, tags:["rock","fast-mana","mox"] , devotion:0, greenPips:0},
  "Lotus Petal":           { type:"artifact", cmc:0, tags:["rock","fast-mana"] , devotion:0, greenPips:0},
  "Utopia Sprawl":         { type:"enchantment", cmc:1, tags:["enchant-land","ramp","aura"] , devotion:1, greenPips:1},
  "Wild Growth":           { type:"enchantment", cmc:1, tags:["enchant-land","ramp","aura"] , devotion:1, greenPips:1},
  "Elvish Guidance":       { type:"enchantment", cmc:3, tags:["enchant-land","ramp","aura","elf-synergy"], devotion:1, role:"elf-mana", greenPips:1},
  // STAX / INTERACTION
  ...
  // TUTORS
  "Worldly Tutor":         { type:"instant", cmc:1, tags:["tutor","instant"] , devotion:0, greenPips:1},
  "Chord of Calling":      { type:"instant", cmc:3, tags:["tutor","instant","convoke"] , devotion:0, greenPips:3},
  "Summoner's Pact":       { type:"instant", cmc:0, tags:["tutor","instant","free"] , devotion:0, greenPips:0},
  "Shared Summons":        { type:"instant", cmc:5, tags:["tutor","instant","two-creatures"] , devotion:0, greenPips:2},
  "Green Sun's Zenith":    { type:"sorcery", cmc:1, tags:["tutor","sorcery"] , devotion:0, greenPips:1},
  "Natural Order":         { type:"sorcery", cmc:4, tags:["tutor","sorcery","sacrifice"] , devotion:0, greenPips:2},
  "Eldritch Evolution":    { type:"sorcery", cmc:3, tags:["tutor","sorcery","sacrifice"] , devotion:0, greenPips:1},
  "Fierce Empath":         { type:"creature", cmc:3, tags:["tutor","elf","etb"] , devotion:1, greenPips:1},
  "Elvish Harbinger":      { type:"creature", cmc:3, tags:["tutor","elf","dork"] , devotion:1, greenPips:1},
  "Fauna Shaman":          { type:"creature", cmc:2, tags:["tutor","elf","engine"] , devotion:1, greenPips:1},
  "Survival of the Fittest":{ type:"enchantment", cmc:2, tags:["tutor","engine","survival"] , devotion:1, greenPips:1},
  "Crop Rotation":         { type:"instant", cmc:1, tags:["tutor","land","instant"] , devotion:0, greenPips:1},
  "Sylvan Scrying":        { type:"sorcery", cmc:2, tags:["tutor","land"] , devotion:0, greenPips:1},
  "Archdruid's Charm":     { type:"instant", cmc:3, tags:["tutor","land","removal","instant"] , devotion:0, greenPips:1},
  // INTERACTION / UTILITY
  ...
  // OTHER UTILITY
  "Yisan, the Wanderer Bard": { type:"creature", cmc:3, tags:["tutor","engine","yisan"] , devotion:1, greenPips:1},
  "Magus of the Candelabra": { type:"creature", cmc:1, tags:["combo","untap-lands"] , devotion:1, greenPips:1},
  "Tireless Provisioner":  { type:"creature", cmc:3, tags:["combo","landfall","treasure"] , devotion:1, role:"ramp-combo", greenPips:1},
  "Badgermole Cub":        { type:"creature", cmc:2, tags:["combo","mana-doubler"] , devotion:1, role:"haste-combo", greenPips:1},
  "Woodcaller Automaton":  { type:"creature", cmc:4, tags:["combo","untap-land"] , devotion:2, greenPips:2}, // prototype {2}{G}{G}=CMC4 (3/3); full cost {10}=CMC10 (8/8). Always cast at prototype.
  "Sowing Mycospawn":      { type:"creature", cmc:4, tags:["removal","land-tutor"] , devotion:1, greenPips:1},
  "Formidable Speaker":    { type:"creature", cmc:3, tags:["combo","tutor","untap","elf"] , devotion:1, greenPips:1},
  "Chomping Changeling":   { type:"creature", cmc:3, tags:["elf","changeling"] , devotion:1, greenPips:1},
  "Delighted Halfling":    { type:"creature", cmc:1, tags:["dork","1drop","protection"] , devotion:1, role:"protection", note:"{T}: Add {C}. {T}: Add one mana of any color to cast a legendary spell — that spell can't be countered. Protects Yeva, Ashaya, Yisan against blue. CMC 1 — true 1-drop that both ramps and shields legends."},
  "Elvish Reclaimer":      { type:"creature", cmc:1, tags:["land-tutor","elf","1drop"] , devotion:1, greenPips:1},
  "Yeva, Nature's Herald": { type:"creature", cmc:4, tags:["commander","flash-enabler"] , devotion:2, greenPips:2},

  // ── VARIANT / SIDEBOARD CARDS ──────────────────────────────────────────
  // Mana dorks & big dorks
  "Joraga Treespeaker":    { type:"creature", cmc:1, tags:["dork","elf","1drop","big-dork","infinite-dork"], tapsFor:"elves", devotion:1, role:"dork-combo", greenPips:1},
...
const COMBOS = [
  ...
  // ── 3. Ashaya + Argothian Elder (2-card combo!) ───────────────────────
  {
    ...
    type: "infinite-mana",
    lines: [
      "Ashaya in play — Argothian Elder is now a Forest land.",
      "Activate Argothian Elder's tap ability ({T}): untap two target lands — target ELDER ITSELF and any other land you control.",
      "Elder taps (ability cost), then the effect untaps Elder. Elder is back to untapped. The second land also untaps.",
      "Tap that second land for N mana (even 1 Forest = {G} per loop).",
      "Repeat from step 2 — Elder is untapped and ready again.",
      "This is a clean 2-card combo. Each loop Elder re-untaps itself for free; all mana comes from the second land.",
    ]
  },
  ...
  // ── 8. Temur Sabertooth/Kogla + Hyrax Tower Scout + Dork (≥6 mana) ────
  {
    ...
    description: "Infinite mana. Scout's ETB untaps a creature. Bounce Scout with Sabertooth/Kogla, recast it to untap the big dork. Loop cost: {1}{G} bounce + {2}{G} recast = 5 mana total. Net positive when dork produces ≥6.",
    ...
    lines: [
      ...
      "Total cost per loop: {1}{G} bounce + {2}{G} recast = 5 mana. Net: ≥{G} when dork taps for ≥6.",
  ...
  // ── 9. Temur Sabertooth + Woodcaller Automaton + Cradle/Nykthos (≥7) ───
  {
    ...
    type: "infinite-mana",
    lines: [
      "Temur Sabertooth + Woodcaller Automaton on battlefield. Gaea's Cradle or Nykthos tapping for ≥7.",
      "Cast Woodcaller Automaton at prototype cost ({2}{G}{G}) — enters as a 3/3.",
      "ETB triggers (cast only): untap one target land (Cradle or Nykthos). That land becomes a 3/3 Treefolk creature with haste. It is still a land.",
      "Tap Cradle/Nykthos for ≥7 mana.",
      "Pay {1}{G}: Sabertooth bounces Woodcaller Automaton to hand.",
      "Recast Woodcaller Automaton at prototype ({2}{G}{G}): ETB untaps and re-animates Cradle/Nykthos again.",
      "Total loop cost: {1}{G} bounce + {2}{G}{G} recast = 6 mana. Net: ≥+{G} when land taps for ≥7.",
      "Repeat for infinite mana.",
    ]
  },
  ...
  // ── 10b. Fanatic of Rhonas + Ashaya + Quirion/Scryb Ranger ──────────────
  {
    ...
    description: "Infinite mana. Fanatic of Rhonas taps for {G} normally, or {G}{G}{G}{G} via Ferocious (needs a power-4+ creature). Ashaya's power equals the number of Forests you control — with Ashaya on board all your creatures are Forests, so her power scales with your board. Ferocious is active as long as Ashaya's power is ≥4 (i.e. you control ≥4 Forests/creatures). Quirion Ranger returns itself to untap Fanatic (loop cost {G}), netting {3}. Scryb Ranger variant costs {1}{G} to recast, netting {2}. Both are clean infinite mana lines.",
    ...
    lines: [
      ...
      "Tap Fanatic of Rhonas as a Forest (via Ashaya) for {G}{G}{G}{G} — Ferocious is active because Ashaya's power equals the number of Forests you control (all creatures are Forests via Ashaya), so with ≥4 creatures on board Ashaya is power 4+.",
  ...
  // Covers Spellbook #4 (Llanowar Elves) and #5 (Elvish Mystic) — no Ashaya required.
  {
    ...
    name: "Temur Sabertooth + Wirewood Symbiote + Circle of Dreams Druid + 1-drop Elf (no Ashaya)",
    onBattlefield: ["Temur Sabertooth", "Wirewood Symbiote", "Circle of Dreams Druid"],
    mustPreExist: ["Circle of Dreams Druid"],
    description: "Infinite mana without Ashaya. Spellbook combos #4/#5. Circle of Dreams Druid taps for {G} per creature. Wirewood Symbiote returns a 1-drop elf to hand, untapping Circle. Temur Sabertooth bounces Symbiote (resetting once-per-turn), costing {1}{G}. Recast Symbiote ({G}) and the 1-drop ({G}). Net positive when Circle taps for ≥5 (i.e. you control ≥5 creatures).",
    requires: ["Temur Sabertooth", "Wirewood Symbiote", "Circle of Dreams Druid"],
    needsOneDrop: true,
    needsBigDork: 5,
    priority: 8,
    type: "infinite-mana",
    lines: [
      "Temur Sabertooth + Wirewood Symbiote + Circle of Dreams Druid + a 1-drop elf (e.g. Llanowar Elves or Elvish Mystic) all on battlefield. Control at least 5 creatures. Circle does NOT have summoning sickness.",
      "Tap Circle of Dreams Druid for ≥5 {G} (one per creature you control).",
      "Activate Wirewood Symbiote: return the 1-drop elf to hand, untapping Circle of Dreams Druid.",
      "Pay {1}{G}: activate Temur Sabertooth, returning Wirewood Symbiote to hand (resets its once-per-turn restriction).",
      "Cast Wirewood Symbiote ({G}). Cast the 1-drop elf ({G}). Total loop cost: {3}{G}.",
      "Net mana per loop: (creatures controlled) − 4. With 5 creatures = +1 per loop. Repeat for infinite mana.",
    ]
  },
  ...
  // ── ENGINE: Eladamri, Korvecdal (Library Casting Engine) ─────────────────────
  {
    id: "eladamri_yavimaya",
    name: "Eladamri, Korvecdal (Library Casting Engine)",
    onBattlefield: ["Eladamri, Korvecdal"],
    description: "Eladamri lets you look at the top of your library at any time and cast creature spells from the top of your library. His activated ability ({G},{T}, tap two untapped creatures) cheats the top card or a card from hand directly onto the battlefield. With infinite mana and a board of creatures, he acts as a repeating creature-into-play engine — effectively a free Chord of Calling every activation.",
    requires: ["Eladamri, Korvecdal"],
    priority: 6,
    type: "engine",
    lines: [
      "Eladamri on battlefield — you may look at the top card of your library at any time.",
      "You may cast creature spells from the top of your library (at instant speed with Yeva's flash).",
      "Activated ability: {G}, {T}, tap two untapped creatures you control — reveal the top card of your library or a card from your hand. If it's a creature card, put it onto the battlefield. Otherwise, put it on the bottom of your library.",
      "With infinite mana: activate repeatedly, tapping creatures already on board to pay the creature cost. Each activation puts a creature directly into play.",
      "Pairs with Seedborn Muse: untap all creatures between opponent turns for free repeated activations.",
      "Best targets: Ashaya (to go infinite), Temur Sabertooth, Kogla, or any missing combo piece.",
    ]
  },
  ...
  // ── Kogla + Karametra's Acolyte (no haste required, Spellbook #2) ────────
  {
    id: "kogla_karametra_loop",
...
// ── MANA ENGINE ──────────────────────────────────────────────
//
// Three entry points, one set of rules:
//
//   buildBoardContext(battlefield, sickSet?, attachments?)
//     → derived counts + per-land aura bonus map
//
//   cardManaContribution(card, data, ctx, sickSet?)
//     → { green, colorless } for a single permanent
//        (pure per-card logic; enchant-land auras return {0,0}
//         — their bonus is applied via landAuraBonuses instead)
//
//   sumManaPool(battlefield, sickSet?, attachments?)
//     → { green, colorless, total }
//        applies per-card contributions + per-land aura bonuses
//        + battlefield-wide bonuses (Earthcraft, Elvish Guidance)
//
// attachments: Map<auraIndex, targetLandIndex> — optional.
// When absent the engine falls back to the flat-bonus heuristic
// (aura count added to total pool) for backward compatibility.
//
// Adding a new enchant-land card? Add it to ENCHANT_LAND_BONUS
// below (returns { green, colorless } it adds to its target).
// ============================================================

// Per-card mana bonus that an enchant-land aura grants its target.
// Used by sumManaPool when attachments are known.
function enchantLandBonus(auraName) {
  if (auraName === "Utopia Sprawl") return { green: 1, colorless: 0 };  // +{G}
  if (auraName === "Wild Growth")   return { green: 1, colorless: 0 };  // +{G}
  if (auraName === "Elvish Guidance") return null; // handled specially (elf-count dependent)
  // Scryfall-loaded auras with enchant-land tag: assume +1{G} by default
  const data = getCard(auraName);
  if (data?.tags?.includes("enchant-land")) return { green: 1, colorless: 0 };
  return null;
}
...
function buildBoardContext(battlefield, sickSet = null, attachments = null) {
  ...
  // Fanatic of Rhonas itself is power 3 — it does NOT enable its own ferocious.
  const POWER4_TAGS = new Set(["power4","big-creature"]);
  // Ashaya's power = number of Forests you control (all creatures are Forests with Ashaya out,
  // so her power scales with creature count). Only treat her as power 4+ when there are ≥4 creatures.
  const POWER4_NAMES = new Set(["Kogla, the Titan Ape","Temur Sabertooth","Selvala, Heart of the Wilds","Yorvo, Lord of Garenbrig","Vorinclex, Voice of Hunger","Craterhoof Behemoth","Primeval Titan","Nylea, God of the Hunt","Rhonas the Indomitable","Ghalta, Primal Hunger"]);
  const ashayaOnBoard = battlefield.includes("Ashaya, Soul of the Wild");
  const hasFerocious = creatures.some(c => {
    const cd = getCard(c);
    if (!cd) return false;
    if (POWER4_NAMES.has(c)) return true;
    if (cd.tags?.some(t => POWER4_TAGS.has(t))) return true;
    return false;
  }) || (ashayaOnBoard && creatures.length >= 4); // Ashaya is power 4+ when you control ≥4 creatures (all Forests)
  ...
  // Only populated when attachments are provided.
  const landAuraBonuses = new Map();
  if (attachments && attachments.size > 0) {
    for (const [auraIdx, landIdx] of attachments) {
      const auraName = battlefield[auraIdx];
      if (!auraName) continue;
      const bonus = enchantLandBonus(auraName);
      const existing = landAuraBonuses.get(landIdx) ?? { green: 0, colorless: 0, hasElvishGuidance: false };
      if (auraName === "Elvish Guidance") {
        existing.hasElvishGuidance = true;
      } else if (bonus) {
        existing.green     += bonus.green;
        existing.colorless += bonus.colorless;
      }
      landAuraBonuses.set(landIdx, existing);
    }
  }

  // attachedLandIndices: Set of land indices that have at least one aura attached.
  // Used to check "is there a Forest enchanted with an aura?" without scanning all attachments.
  const attachedAuraLands = new Set(landAuraBonuses.keys());

  // hasAuraOnForest: true if any Forest-type land has an enchant-land aura.
  // When attachments are known this is precise; otherwise falls back to hasAura heuristic.
  const hasAuraOnForest = attachments
    ? [...attachedAuraLands].some(idx => {
        const land = battlefield[idx];
        const tags = getCard(land)?.tags ?? [];
        return tags.includes("basic") || tags.includes("forest") ||
               land === "Yavimaya, Cradle of Growth";
      })
    : hasAura;
  ...
  return {
    ...
    hasCradle, hasNykthos, landCount, basicForests,
    landAuraBonuses, attachedAuraLands,
  };
}

// Returns { green, colorless } for a single card given pre-built board context.
// Does NOT include battlefield-wide bonuses (Earthcraft, Utopia Sprawl, Elvish Guidance).
function cardManaContribution(card, data, ctx, sickSet = null) {
  if (sickSet?.has(card) && (data.tags?.includes("dork") || data.tags?.includes("big-dork"))) {
  ...
  if (data.type === "land") {
    ...
    if (typeof t === "number") {
      ...
      amt = devotion + badgermoleBonus;
    } else if (t === "ferocious") {
      // Fanatic of Rhonas: {T}: {G}. Ferocious — {T}: {G}{G}{G}{G} if you control a power-4+ creature.
      // Fanatic itself is power 3, so it cannot enable its own ferocious.
      amt = ctx.hasFerocious ? 4 : 1;
    } else if (t === "arbor") {
      if (hasYavimaya && (hasCradle || hasNykthos)) {
        amt = Math.max(creatureCount, devotion - 2) + badgermoleBonus;
      } else if (hasAura) {
    ...
    if (card === "Lotus Petal") return { green: 1, colorless: 0 };
    return { green: 0, colorless: 0 };
  }
...
// Sum all mana from a battlefield. Replaces calculateBattlefieldMana + calculateSimManaPool.
function sumManaPool(battlefield, sickSet = null, attachments = null) {
  const ctx = buildBoardContext(battlefield, sickSet, attachments);
  let green = 0;
  let colorless = 0;

  for (let i = 0; i < battlefield.length; i++) {
    const card = battlefield[i];
    const data = getCard(card);
    if (!data) continue;

    // Enchant-land auras: when attachments are known, their bonus is applied to
    // the target land index below. Skip here to avoid double-counting.
    if (attachments && data.tags?.includes("enchant-land")) continue;

    const c = cardManaContribution(card, data, ctx, sickSet);
    let g = c.green;
    let col = c.colorless;

    // Apply aura bonuses attached to this land (precise mode).
    if (attachments && data.type === "land" && ctx.landAuraBonuses.has(i)) {
  ...
  // Earthcraft: each non-sick creature taps to untap a basic land
...
const calculateBattlefieldMana = sumManaPool;
const calculateSimManaPool     = sumManaPool;

// Used by the Goldfish tap-a-source handler — returns a flat total for the mana pool integer.
function calculateCardManaForPool(card, battlefield) {
  const data = getCard(card);
  if (!data) return 0;
  const ctx = buildBoardContext(battlefield);
  const { green, colorless } = cardManaContribution(card, data, ctx);
...
function analyzeGameState({ hand, battlefield, graveyard, manaAvailable, isMyTurn, yisanCounters = 0, opponentThreats, lifeTotal, deckList = null, attachments = null }) {
  ...
  const witnessRetrievable = (cardName) => {
    ...
    // Skullwinder in hand — ETB retrieves from graveyard (costs {2}{G})
  ...
  // ── Normalise manaAvailable ──────────────────────────────────────────────────
  // Accepts either a legacy flat number or a {green, colorless} object from the UI.
  // All downstream logic uses `green`, `colorless`, and `totalMana`, plus canAfford().
  const _raw = manaAvailable;
  const greenMana     = (typeof _raw === "object" && _raw !== null) ? (parseInt(_raw.green)     || 0) : 0;
  const colorlessMana = (typeof _raw === "object" && _raw !== null) ? (parseInt(_raw.colorless) || 0) : 0;
  const totalMana     = (typeof _raw === "object" && _raw !== null)
    ? greenMana + colorlessMana
    : (parseInt(_raw) || 0);
  // When passed a flat number we can't know the split — assume all green (conservative)
  const availGreen     = (typeof _raw === "object" && _raw !== null) ? greenMana : totalMana;
  ...
  function estimateDorkOutput(cardName, extraElves = 0) {
    ...
    if (t === "arbor") {
      ...
      // With an aura on a Forest: untapping it yields 2+ mana
  ...
  function comboExtrasSatisfied(combo, infiniteMana = false) {
    ...
    if (combo.needsAlso) {
      ...
      const auraLandReady = combo.needsAuraLand && (() => {
        if (attachments) {
          // Count how many Forests have aura attachments
          const enchantedForests = [...boardCtx.attachedAuraLands].filter(idx => {
            const land = battlefield[idx];
            const tags = getCard(land)?.tags ?? [];
            return tags.includes("basic") || tags.includes("forest") || land === "Yavimaya, Cradle of Growth";
          });
          if (combo.needsAuraLand3) {
            const hasGuidanceWithElves = boardCtx.attachedAuraLands.size > 0 &&
              [...boardCtx.landAuraBonuses.values()].some(b => b.hasElvishGuidance) &&
              elvesOnBoard >= 3;
            return enchantedForests.length >= 2 || hasGuidanceWithElves;
          }
          return enchantedForests.length >= 1;
        }
        // Fallback: heuristic (no attachments provided)
        ...
        if (!forestOnBoard) return false;
        return combo.needsAuraLand3
    ...
    // Valid methods:
    //   1. Woodcaller Automaton (ETB untaps one land, animates it with haste)
    ...
    if (combo.needsUntapLand) {
      ...
      const hasHyrax       = board.has("Hyrax Tower Scout") || inHand.has("Hyrax Tower Scout");
  ...
  if (creatureDorksOnBoard === 0 && !infiniteManaActive) {
    ...
    if (dorks1.length > 0) {
      const dork = dorks1[0];
      const isHalfling = dork === "Delighted Halfling";
      const LEGENDS = ["Ashaya, Soul of the Wild","Yeva, Nature's Herald","Yisan, the Wanderer Bard","Kogla, the Titan Ape","Eladamri, Korvecdal","Selvala, Heart of the Wilds"];
      const legendsInHand = isHalfling ? hand.filter(c => LEGENDS.includes(c)) : [];
      const halflingHint = legendsInHand.length > 0
      ...
      results.push({
        ...
        steps: [
          `Cast ${dork} ({${getCard(dork)?.cmc ?? 1}}).`,
          "It untaps next turn — tap for mana to accelerate toward your combo threshold.",
          ...(legendsInHand.length > 0 ? [`When you cast ${legendsInHand[0]}: tap Delighted Halfling to add {C} toward the cost — that spell cannot be countered.`] : []),
        ],
        color: "#52be80",
      });
    }
  ...
  if ((isMyTurn || yevaAvailable) && !infiniteManaActive) {
    const rangers = ["Quirion Ranger", "Scryb Ranger"].filter(r =>
      inHand.has(r) && !board.has(r) && canAfford(getCard(r)?.cmc ?? 1, 1)
    );
    if (rangers.length > 0 && !results.some(r => r.headline?.includes(rangers[0]))) {
      const ranger = rangers[0];
      const hasAshaya = board.has("Ashaya, Soul of the Wild") || inHand.has("Ashaya, Soul of the Wild");
      const hasDork   = battlefield.some(c => getCard(c)?.tags?.includes("dork"));
      const comboHint = hasAshaya
        ? `With Ashaya in play, ${ranger} becomes the untap engine for infinite mana.`
        : `Pairs with Ashaya + a big dork for infinite mana.`;
      results.push({
        priority: hasDork ? 8 : 7,
        category: "🌱 RAMP",
        combo: `cast_ranger_${ranger.toLowerCase().replace(/[^a-z]/g, "_")}`,
        headline: `Cast ${ranger} ({${getCard(ranger)?.cmc ?? 1}}) — key untap engine`,
        detail: `${ranger} is a critical combo piece. Once-per-turn: return a Forest you control to hand to untap a creature. ${comboHint}`,
        steps: [
          `Cast ${ranger} ({${getCard(ranger)?.cmc ?? 1}}).`,
          hasDork
            ? `Use ${ranger}'s ability: return a Forest to hand → untap a mana dork for extra mana this turn.`
            : `Hold for when you have a dork on board — then activate to untap it for bonus mana.`,
          ...(hasAshaya ? [`With Ashaya: ${ranger} and creatures become Forests — enables the infinite untap loop.`] : []),
        ],
        color: "#52be80",
      });
    }
  ...
  if (isMyTurn || yevaAvailable) {
    ...
    if (castableBigDorks.length > 0 && !infiniteManaActive) {
      ...
      if (cd.tapsFor === "elves") {
        ...
        const devCount = devotionOnBoard + (cd.devotion ?? 1);
      ...
      const enablesCombo = [];
      if (board.has("Temur Sabertooth") || inHand.has("Temur Sabertooth")) enablesCombo.push("Temur Sabertooth loop");
      if (board.has("Wirewood Lodge") || inHand.has("Wirewood Lodge")) enablesCombo.push("Wirewood Lodge untap");
      if (board.has("Quirion Ranger") || inHand.has("Quirion Ranger") || board.has("Scryb Ranger") || inHand.has("Scryb Ranger")) enablesCombo.push("Quirion/Scryb Ranger loop");
      const comboHint = enablesCombo.length > 0 ? ` Enables: ${enablesCombo.slice(0, 2).join(", ")}.` : "";

      const isFlash = !isMyTurn && yevaAvailable;
      // On my turn, casting a big dork is a concrete immediate action — prioritise it above
      // "find a missing piece" advice (priority 8). Flash/EOT plays keep the lower scale
      // because they require an opponent turn window and Yeva.
      const priority = isFlash
        ? (projectedOutput >= 4 ? 8 : 7)    // EOT flash: unchanged
        : (projectedOutput >= 4 ? 10 : 9);  // My turn: castable now → always beats ONE PIECE AWAY / TUTOR (priority 8)

      results.push({
        priority,
        combo: `cast_big_dork_${dork.toLowerCase().replace(/[^a-z]/g, "_")}`,
        category: "🌱 RAMP",
        headline: isFlash
          ? `Flash in ${dork} at EOT — ${tapDesc}`
          : `Cast ${dork} ({${cd.cmc}}) — ${tapDesc}`,
  ...
  if (inHand.has("Earthcraft") && !board.has("Earthcraft") && canAfford(2, 1)) {
    ...
    if (basicLands > 0 && tappableCreatures > 0) {
      ...
      results.push({
        ...
        category: "🌱 RAMP",
        combo: "cast_earthcraft",
        headline: `Cast Earthcraft ({1}{G}) — tap ${tappableCreatures} creature${tappableCreatures > 1 ? "s" : ""} to untap ${extraMana} basic land${extraMana > 1 ? "s" : ""} (+${extraMana} extra mana this turn)`,
        detail: `Earthcraft lets you tap any untapped creature to untap a basic land. With ${tappableCreatures} creature${tappableCreatures > 1 ? "s" : ""} and ${basicLands} basic land${basicLands > 1 ? "s" : ""}, you gain +${extraMana}{G} immediately.${comboHint}`,
        steps: [
          `Cast Earthcraft ({1}{G}).`,
          ...Array.from({ length: extraMana }, (_, i) =>
            `Tap creature ${i + 1} via Earthcraft → untap a basic Forest → tap Forest again for {G}.`
          ),
          ...(comboHint ? [comboHint.trim()] : []),
        ],
        color: "#52be80",
      });
    }
  ...
  // Case A: Arbor Elf on board, aura in hand — cast the aura to unlock double-mana
  ...
  // Case B: Aura already on board, Arbor Elf in hand — cast Arbor Elf to unlock double-mana NOW
  ...
  if (inHand.has("Hope Tender") && !board.has("Hope Tender") && (mana >= 2 || infiniteManaActive) && !infiniteManaActive) {
    const hasYavimaya = board.has("Yavimaya, Cradle of Growth");
    ...
    const hasUntapper = hasKogla || hasLodge || hasRanger;
    const hasSynergy  = hasBigLand || hasYavimaya || hasUntapper;

    const target = board.has("Gaea's Cradle") ? "Gaea's Cradle"
      : board.has("Nykthos, Shrine to Nyx") ? "Nykthos, Shrine to Nyx"
      : hasBigLand ? "a key land" : null;

    const priority = hasBigLand ? 8 : hasSynergy ? 7 : 7; // always at least 7 — concrete ramp play

    const headline = hasKogla && target
  ...
  // ---- DUSKWATCH RECRUITER ACTIVATION ----
  // With spare mana, Duskwatch is a repeatable creature tutor ({2}{G}: look at top 3, reveal a creature).
  // Key targets: Ashaya, Quirion Ranger, Scryb Ranger, Priest of Titania, Circle of Dreams Druid, etc.
  if (board.has("Duskwatch Recruiter") && (mana >= 3 || infiniteManaActive)) {
    const activations = infiniteManaActive ? "∞" : Math.floor(mana / 3);
    const keyTargets = [
      "Ashaya, Soul of the Wild", "Quirion Ranger", "Scryb Ranger",
      "Priest of Titania", "Circle of Dreams Druid", "Selvala, Heart of the Wilds",
      "Elvish Archdruid", "Karametra's Acolyte", "Temur Sabertooth", "Kogla, the Titan Ape",
      "Eternal Witness", "Argothian Elder", "Hyrax Tower Scout", "Fanatic of Rhonas",
      "Marwyn, the Nurturer", "Wirewood Channeler", "Formidable Speaker",
    ].filter(c => !board.has(c) && !inHand.has(c));

    // Don't suggest if already used as part of a WIN NOW line
    if (!results.some(r => r.category?.includes("WIN NOW") || r.category?.includes("CAST TO WIN"))) {
      const topTargets = keyTargets.slice(0, 3);
      const targetHint = topTargets.length > 0
        ? `Priority targets: ${topTargets.join(", ")}.`
        : "You already control most key creatures.";
      results.push({
        priority: infiniteManaActive ? 9 : 6,
        category: infiniteManaActive ? "🔍 WIN SETUP" : "🔍 TUTOR",
        combo: "duskwatch_activation",
        headline: infiniteManaActive
          ? `Activate Duskwatch Recruiter (∞) — dig entire library for win pile`
          : `Activate Duskwatch Recruiter ({2}{G}) — look at top 3 cards, find a creature (${activations}× this turn)`,
        detail: `Duskwatch Recruiter: {2}{G} — look at the top 3 cards of your library. You may reveal a creature card and put it into your hand. Put the rest on the bottom in any order. ${targetHint}`,
        steps: infiniteManaActive
          ? [
              "Activate Duskwatch Recruiter ({2}{G}): look at top 3, reveal a creature if found.",
              "With infinite mana, repeat until you find all key pieces.",
              `Fetch in order: ${topTargets.length > 0 ? topTargets.join(" → ") : "remaining combo pieces"}.`,
            ]
          : [
              `Activate Duskwatch Recruiter ({2}{G}): look at top 3 cards.`,
              "If a creature is found, reveal it and put it in hand. Otherwise, reorder the 3 cards to the bottom.",
              ...(activations > 1 ? [`You have ${mana} mana — can activate up to ${activations}× this turn.`] : []),
              ...(topTargets.length > 0 ? [`Best finds: ${topTargets.slice(0, 2).join(", ")}.`] : []),
            ],
        color: "#8e44ad",
      });
    }
  ...
  // are in the graveyard with a recovery path, surface this as high-priority advice.
  {
    ...
    if (graveCombopieces.length > 0) {
      ...
      const hasWitness       = inHand.has("Eternal Witness") && canAfford(3, 2); // {1}{G}{G}
  ...
  if (inHand.has("Natural Order")) {
    ...
    if (hasSacTarget && canAfford(4, 2) && !board.has("Ashaya, Soul of the Wild")) {
      const hasRanger = board.has("Quirion Ranger") || board.has("Scryb Ranger");
      const rangerName = board.has("Quirion Ranger") ? "Quirion Ranger" : "Scryb Ranger";
      const rangerRecastCost = board.has("Quirion Ranger") ? 1 : 2;
      // dorkThreshold: minimum mana a dork must produce to form a valid infinite loop.
  ...
  if (inHand.has("Nature's Rhythm") && isMyTurn) {
    ...
    if (nrTargets.length > 0) {
      ...
      results.push({
        ...
        detail: "Nature's Rhythm ({X}{G}{G}) puts a creature with MV ≤ X directly onto the battlefield. After casting normally it goes to your graveyard — then you can cast it again via Harmonize ({X}{G}{G}{G}{G}, tap creatures to reduce the generic cost by their power), after which it's exiled for good.",
        steps: [
          `Cast Nature's Rhythm with X=${best.xCost} (total cost: ${best.xCost + 2} mana): find ${best.name} → put onto battlefield.`,
          `${best.reason.charAt(0).toUpperCase() + best.reason.slice(1)}.`,
          "Nature's Rhythm goes to graveyard after resolving — save it for a second use via Harmonize.",
          "Harmonize: recast from graveyard for {X}{G}{G}{G}{G}. Tap your biggest creatures to reduce the generic cost by their power. Then the spell is exiled.",
  ...
  // ---- NATURE'S RHYTHM IN GRAVEYARD ----
  // Nature's Rhythm is a sorcery — it never sits on the battlefield.
  // After the first cast it goes to graveyard. Advise on Harmonize reuse if it's there.
  ...
  // ---- SOWING MYCOSPAWN ----
  if (inHand.has("Sowing Mycospawn") && isMyTurn) {
    // On-cast trigger only fires when cast — once it's on the battlefield the tutor has already resolved.
    const castable = mana >= 5 || infiniteManaActive;
    if (castable) {
  ...
  // Cast tutor → get Speaker → bounce loop via Quirion → find Ashaya → loop freely.
  {
    ...
    if (hasRangerForSpeaker && !speakerAlreadyAccess && hasBigDorkForSpeaker) {
      ...
      if (inHand.has("Green Sun's Zenith") && isMyTurn && (mana >= gszCost || infiniteManaActive)) {
        ...
        tutorNow = false;
      } else if (inHand.has("Elvish Harbinger")
  ...
  if (inHand.has("Elvish Harbinger")) {
    const castable = mana >= 3 || infiniteManaActive;
    const etbReady = false; // ETB fires on cast only — already on battlefield means ETB already used
  ...
  if (board.has("Yisan, the Wanderer Bard")) {
    ...
    // verse 2 → CMC 2: Priest of Titania, Fanatic of Rhonas, Duskwatch Recruiter, Destiny Spinner, Earthcraft
    // verse 3 → CMC 3: Temur Sabertooth, Circle of Dreams Druid, Hyrax Tower Scout, Eladamri, Eternal Witness
    // verse 4 → CMC 4: Argothian Elder, Karametra's Acolyte
    // verse 5+ → CMC 5+: Ashaya, Kogla. Woodcaller Automaton is CMC 4 at prototype — fetchable at verse 4.
    const yisanTargetsByVerse = {
      ...
      2: [
        ...
        { name: "Fanatic of Rhonas",      reason: "taps for {G}{G}{G}{G} — massive mana dork at CMC 2" },
      ...
      3: [
        ...
        { name: "Hyrax Tower Scout",      reason: "untaps a creature on ETB — pairs with Temur Sabertooth for loops" },
        { name: "Eladamri, Korvecdal",    reason: "look at and cast creatures from top of library — tutor engine" },
      ...
      4: [
        ...
        { name: "Woodcaller Automaton",   reason: "prototype {2}{G}{G} — ETB untaps and animates a land as a haste creature; loops with Sabertooth or Ashaya" },
      ],
      5: [
  ...
  // NOTE: Nature's Rhythm is a sorcery — the old landfall-draw engine block has been removed.
  ...
  if (board.has("Arbor Elf")) {
    const hasYavimaya = board.has("Yavimaya, Cradle of Growth");
    const hasBigLand  = board.has("Gaea's Cradle") || board.has("Nykthos, Shrine to Nyx");
    // hasAuraOnForest is precise when attachments are known; falls back to board presence check
    if (boardCtx.hasAuraOnForest || (hasYavimaya && hasBigLand)) {
      // Identify the best target land name for advice text
      const auraTarget = attachments
        ? (() => {
            for (const [auraIdx, landIdx] of attachments) {
              const aura = battlefield[auraIdx];
              const land = battlefield[landIdx];
              if (aura && land) return `${aura}-enchanted ${land}`;
            }
            return "enchanted Forest";
          })()
        : board.has("Utopia Sprawl") ? "Utopia Sprawl-enchanted Forest"
        : board.has("Wild Growth") ? "Wild Growth-enchanted Forest"
        : "Elvish Guidance-enchanted Forest";
  ...
  if ((inHand.has("Joraga Treespeaker") || board.has("Joraga Treespeaker")) && (isMyTurn || yevaAvailable)) {
    ...
    const canCast = inHand.has("Joraga Treespeaker") && canAfford(1, 1); // {G}
    const canLevel1 = onBoard && canAfford(2, 1); // {1}{G} to reach level 1 (taps for {G} per elf)
    const canLevel5 = onBoard && canAfford(8, 1); // {7}{G} total to reach level 5 (all elves gain +1/+1)
  ...
  if ((inHand.has("Emerald Medallion") || board.has("Emerald Medallion")) && isMyTurn) {
    if (!board.has("Emerald Medallion") && canAfford(2, 0)) {
      results.push({
        priority: 5,
  ...
  for (const combo of COMBOS) {
    ...
    if (missing.length === 0 && extras.ok) {
      ...
      if (combo.type !== "infinite-mana" || !infiniteManaActive) {
        ...
        const missingPips = missingData?.greenPips ?? Math.min(missingCmc, missingData?.devotion ?? 0);
        // Suppress if we couldn't afford to cast the missing piece even if we had it now.
        const canAffordMissing = infiniteManaActive || missingCmc === 0 || mana >= missingCmc;
        if (!canAffordMissing) {
          // Can't cast the piece even if we find it — suppress
        } else {
  ...
  const bellowerCastable  = bellowerInHand && (isMyTurn || yevaAvailable) && (mana >= 6 || infiniteManaActive);
  ...
  if (duskwatchCastable && (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)) {
  ...
  if (reclaimerCastable || reclaimerCanActivate) {
    ...
    const landTargets = [
      { land: "Gaea's Cradle",          missing: !board.has("Gaea's Cradle") && !inHand.has("Gaea's Cradle"),
        reason: "Taps for {G} per creature — often 4-8+ mana immediately. Core combo enabler.",
        priority: infiniteManaActive ? 7 : 9 },
      { land: "Itlimoc, Cradle of the Sun", missing: !board.has("Itlimoc, Cradle of the Sun") && !board.has("Gaea's Cradle") && !inHand.has("Itlimoc, Cradle of the Sun"),
        reason: `Taps for {G} per creature (currently ${creaturesOnBoard}) — Gaea's Cradle as a land. Fetch when Cradle isn't available.`,
        priority: infiniteManaActive ? 6 : 8 },
      { land: "Geier Reach Sanitarium", missing: !board.has("Geier Reach Sanitarium") && !inHand.has("Geier Reach Sanitarium"),
      ...
      { land: "Nykthos, Shrine to Nyx", missing: !board.has("Nykthos, Shrine to Nyx") && !inHand.has("Nykthos, Shrine to Nyx"),
      ...
      { land: "Wirewood Lodge",         missing: !board.has("Wirewood Lodge") && !inHand.has("Wirewood Lodge"),
      ...
      { land: "Deserted Temple",        missing: !board.has("Deserted Temple") && !inHand.has("Deserted Temple"),
      ...
      { land: "Yavimaya, Cradle of Growth", missing: !board.has("Yavimaya, Cradle of Growth") && !inHand.has("Yavimaya, Cradle of Growth"),
        reason: "Makes all lands Forests for all players. Enables Earthcraft with all creatures, Argothian Elder untap loops, and Arbor Elf tapping any land.",
        priority: board.has("Argothian Elder") ? 8 : 5 },
      { land: "Boseiju, Who Endures",   missing: !board.has("Boseiju, Who Endures") && !inHand.has("Boseiju, Who Endures"),
        reason: "Instant-speed removal for problematic enchantments, artifacts, or lands. Channel ability is uncounterable.",
        priority: 4 },
      { land: "Emergence Zone",         missing: !board.has("Emergence Zone") && !inHand.has("Emergence Zone"),
  ...
  // If infinite mana is active (or mana >= EFFECTIVELY_INFINITE_MANA), Eternal Witness can retrieve a key piece
  // from the graveyard and turn it into a win con.
  if (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA) {
  ...
  if (bellowerCastable) {
    ...
    if (primaryTarget) {
      ...
      const isWinNow = (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)
  ...
  if (inHand.has("Fauna Shaman") && !board.has("Fauna Shaman") && (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)) {
  ...
  // This is NOT just ONE PIECE AWAY — it is a CAST TO WIN NOW play.
  {
    ...
    const canCastYevaThenSpeaker = !isMyTurn && !yevaFlash && yevaAvailable && canAfford(4 + minManaForWin, 3);
    ...
    if (speakerInHandNow && quirionInLoop && winLineAvailable && hasDiscardForSpeaker && !infiniteManaActive) {
      ...
      const dorkForLoop = [...battlefield, ...hand].find(c => {
        if (!getCard(c)?.tags?.includes("big-dork") && !getCard(c)?.tags?.includes("dork")) return false;
        // If dork is in hand, we must have enough mana to cast it AND Speaker this turn
        if (inHand.has(c)) {
          const dorkCmc = getCard(c)?.cmc ?? 0;
          if (mana < 3 + dorkCmc) return false; // can't afford both
        }
        const t = getCard(c)?.tapsFor;
      ...
      if (dorkForLoop && !results.some(r => r.combo === "speaker_hand_cast_to_win")) {
        ...
        if (canCastSpeakerNow) {
          ...
          const yevaTarget = 4 + minManaForWin;
          const yevaHint = mana < yevaTarget
            ? ` (Need ${yevaTarget - mana} more mana to cast Yeva + Speaker${ashayaOnBoard ? "" : " + Ashaya"} this turn.)`
            : "";
          results.push({
            priority: 14,
            category: "⏭️ WIN NEXT TURN",
  ...
  if (accessible("Formidable Speaker") && !board.has("Formidable Speaker")
      && speakerHasBouncer && (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)
  ...
  // ---- INFECTIOUS BITE POISON LINE ----
  {
    ...
    if (biteAvail && witnessOnBrd && hasBouncer && (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)) {
      results.push({
        priority: 14,
        category: "☠️ POISON WIN",
    ...
    if (biteAvail && !witnessOnBrd && faunaFindsWitness && hasBouncer && (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)) {
      results.push({
        priority: 13,
        category: "☠️ POISON WIN",
    ...
    if (biteAvail && !witnessOnBrd && faunaInHandFindsWitness && hasBouncer && (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)) {
      results.push({
        priority: 12,
        category: "☠️ POISON WIN",
    ...
    if (biteAvail && !witnessOnBrd && speakerFindsWitness && (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)) {
      results.push({
        priority: 13,
        category: "☠️ POISON WIN",
    ...
    if (biteAvail && !witnessOnBrd && speakerInHandFindsWitness && (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)) {
      results.push({
        priority: 12,
        category: "☠️ POISON WIN",
    ...
    if (biteAvail && bellowerFindsWitness && hasBouncer && (infiniteManaActive || mana >= EFFECTIVELY_INFINITE_MANA)) {
      results.push({
        priority: 13,
        category: "☠️ POISON WIN",
  ...
  // ---- FAST MANA IN HAND ----
  // Surface zero/low-CMC mana accelerants that haven't been played yet.
  // Only fires when no higher-priority action already calls for them.
  {
    const fastManaInHand = [];
    ...
    if (inHand.has("Lotus Petal") && !infiniteManaActive) {
      ...
      fastManaInHand.push({
        ...
        steps: [
          ...
          ...(nowAffordable.length > 0 ? [`Now at ${newMana} mana — can cast: ${nowAffordable.join(", ")}.`] : [`Adds 1 mana to your pool for this turn.`]),
        ],
        priority: 5,
      });
    }
    ...
    if (inHand.has("Chrome Mox") && !board.has("Chrome Mox") && !infiniteManaActive) {
      ...
      const imprintTargets = hand.filter(c => {
        if (c === "Chrome Mox") return false;
        const cd = getCard(c);
        if (!cd || cd.type === "land") return false;
        if (cd.tags?.includes("mox")) return false;
        if (IMPRINT_BLOCKLIST_NAMES.has(c)) return false;
        if (cd.tags?.some(t => IMPRINT_BLOCKLIST_TAGS.has(t))) return false;
        return true;
      });
      if (imprintTargets.length > 0) {
        const bestImprint = imprintTargets[0];
        fastManaInHand.push({
          name: "Chrome Mox",
          headline: `Cast Chrome Mox (free) → imprint ${bestImprint} → tap for {G}`,
          detail: "Chrome Mox enters for free. Imprinting a card exiles it permanently but gives you a free {G} every turn. Only imprint cards you can afford to lose — avoid imprinting key combo pieces.",
          steps: [
            `Cast Chrome Mox ({0}).`,
            `Imprint ${bestImprint} (exile it) — Chrome Mox now taps for {G}.`,
            "Tap Chrome Mox for {G}.",
          ],
          priority: 4,
        });
      }
    ...
    if (inHand.has("Mox Diamond") && !board.has("Mox Diamond") && !infiniteManaActive) {
      const landToDiscard = hand.find(c => getCard(c)?.type === "land");
      if (landToDiscard) {
        fastManaInHand.push({
          name: "Mox Diamond",
          headline: `Cast Mox Diamond (free) → discard ${landToDiscard} → tap for {G}`,
          detail: "Mox Diamond enters for free but requires discarding a land as it enters. Gives you a free {G} each turn — worthwhile if you have a land to spare or already made your land drop.",
          steps: [
            `Cast Mox Diamond ({0}).`,
            `Discard ${landToDiscard} as the enters-the-battlefield cost.`,
            "Tap Mox Diamond for {G}.",
          ],
          priority: 4,
        });
      }
    ...
    for (const fm of fastManaInHand) {
      // Don't fire if a higher-priority action already covers this card
      const alreadyCovered = results.some(r => r.headline?.includes(fm.name));
      if (!alreadyCovered) {
        results.push({
          priority: fm.priority,
          category: "⚡ FAST MANA",
          combo: `fast_mana_${fm.name.toLowerCase().replace(/\s/g, "_")}`,
  ...
  if (!winFired("natural_order_ashaya_win")) {
    ...
    if (noInHand && hasSacNO && !hasAshaya) {
      ...
      if (!canAfford(4, 2)) {
        const pipShort = availGreen < 2 ? ` (need ${2 - availGreen} more {G})` : "";
        const manaShort = mana < 4 ? ` (need ${4 - mana} more total)` : "";
        needs.push(`can't cast Natural Order {2}{G}{G}${pipShort}${manaShort}`);
      }
  ...
  if (!winFired("speaker_hand_cast_to_win") && !winFired("speaker_inf_duskwatch_direct") && !winFired("full_hand_inf_speaker_win")) {
    ...
    const hasFullHandPath = accessible("Ashaya, Soul of the Wild") && accessible("Argothian Elder") &&
      canAfford(isMyTurn ? 8 : yevaFlash ? 8 : 12, 3);
    // Only suppress if the combo is at least partially assembled (ranger or Ashaya already on board).
    // Without any pieces in play this is just noise for any deck that runs Speaker.
    const speakerPartiallyAssembled = hasRangerSpkr || board.has("Ashaya, Soul of the Wild");
    if (spkrAvail && !infiniteManaActive && !hasFullHandPath && speakerPartiallyAssembled) {
      const needs = [];
      ...
      if (!canAfford(3, 1)) {
        const pipShort = availGreen < 1 ? " (need {G})" : "";
        const manaShort = mana < 3 ? ` (need ${3 - mana} more total)` : "";
        needs.push(`can't cast Formidable Speaker {2}{G}${pipShort}${manaShort}`);
      }
      if (needs.length > 0)
  ...
  if (!winFired("bellower_duskwatch_win") && accessible("Woodland Bellower")) {
    ...
    else if (!canAfford(6, 2)) {
      const pipShort = availGreen < 2 ? ` (need ${2 - availGreen} more {G})` : "";
      suppressedWins.push({ label: "Woodland Bellower win suppressed", reason: `only ${mana} mana (need 6){2}{G}{G}${pipShort}` });
    }
  }
  ...
  if (!infiniteManaActive) {
    for (const combo of COMBOS.filter(c => c.type === "infinite-mana")) {
      ...
      // mustPreExist cards must actually be on the battlefield (not just accessible)
      const preExistMissing = (combo.mustPreExist ?? []).filter(r => !board.has(r));
      if (missing.length === 0 && preExistMissing.length === 0) {
        const extras = comboExtrasSatisfied(combo, infiniteManaActive);
  ...
  for (const s of suppressedWins) {
    if (results.some(r => r.suppressedLabel === s.label)) continue; // no dups by label
    if (seenReasons.has(s.reason)) continue; // no dups by identical reason text
    seenReasons.add(s.reason);
    results.push({
      priority: -1,
      category: "🔕 SUPPRESSED",
...
function buildMillSequence(board, hand, pileNeeded = []) {
  ...
  if (hasSanitarium && hasWoodcaller && hasTemur && hasEndurance) {
    const loop = [
      ...
      `  3. Recast Woodcaller Automaton at prototype ({2}{G}{G}). ETB: untap target land — target Geier Reach Sanitarium. Sanitarium is now untapped.`,
...
function deriveCardEntry(sf) {
  ...
  // "forest" = printed Forest subtype (Quirion Ranger target, Arbor Elf target, etc.)
  if (typeLine.includes("forest")) {
    if (!tags.includes("forest")) tags.push("forest");
  }
  // "fetch-forest" = land that can find/produce green but is NOT a Forest itself (fetchlands, green-mana sources)
  if (!typeLine.includes("forest") && (oracle.includes("add {g}") || oracle.includes("add one mana of any color") || oracle.includes("search your library for a forest"))) {
    if (!tags.includes("fetch-forest")) tags.push("fetch-forest");
  }
    ...
    fetch(`https://api.scryfall.com/cards/named?exact=${encoded}`)
      ...
      .then(data => {
        ...
        if (data?.image_uris?.normal) {
          ...
          // DFC: pick the face whose name matches what we asked for
          const faces = data.card_faces;
          const matchIdx = faces.findIndex(f => f.name?.toLowerCase() === name.toLowerCase());
          const face = faces[matchIdx !== -1 ? matchIdx : 0];
          imgUrl = face?.image_uris?.normal || "error";
        } else {
          imgUrl = "error";
        }
...
function CardPill({ name, onRemove, zone, onDragStart, onPlay, attachedTo }) {
  ...
  return (
    ...
    >
      ...
      {attachedTo && (
        <span style={{
          fontSize: "10px", color: COLORS.green3, fontFamily: "'Cinzel', serif",
          letterSpacing: "0.5px", opacity: 0.8,
          background: COLORS.green3 + "18", borderRadius: "3px",
          padding: "1px 4px", marginLeft: "1px",
        }}>
          ↠ {attachedTo}
        </span>
      )}
...
function CardInput({ label, zone, cards, onAdd, onRemove, placeholder, deckCards, onRef, onDropCard, onPlay, attachments }) {
  ...
  return (
    <div style={{ marginBottom: "16px" }}>
      ...
      >
        ...
        {cards.map((n, i) => {
          const targetIdx = attachments?.get(i);
          const attachedTo = (targetIdx != null) ? cards[targetIdx] : undefined;
          return <CardPill key={`${n}-${i}`} name={n} zone={zone} onRemove={onRemove} onPlay={onPlay} attachedTo={attachedTo} />;
        })}
      </div>
...
// ── AURA TARGET MODAL ────────────────────────────────────────────────────────
// Shown when an enchant-land aura is added to the battlefield.
// Lets the user choose which land it enchants.
function AuraTargetModal({ auraName, lands, onConfirm, onSkip }) {
  return (
    <div style={{
    ...
    >
      <div style={{
        background: "#0d1f0d", border: `1px solid ${COLORS.green3}`,
        borderRadius: "12px", padding: "24px 28px", maxWidth: "400px", width: "100%",
        boxShadow: "0 16px 48px rgba(0,0,0,0.8)",
      }}
        onClick={e => e.stopPropagation()}
      >
        <div style={{ fontFamily: "'Cinzel', serif", fontSize: "13px", letterSpacing: "2px",
          color: COLORS.green3, marginBottom: "6px", textTransform: "uppercase" }}>
          Enchant Land
        </div>
        <div style={{ fontFamily: "'Crimson Text', serif", fontSize: "15px",
          color: COLORS.text, marginBottom: "18px" }}>
          Which land does <strong style={{ color: COLORS.gold }}>{auraName}</strong> enchant?
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: "6px", marginBottom: "16px" }}>
          {lands.map(({ name, idx }) => (
            <button key={idx} onClick={() => onConfirm(idx)}
              style={{
                background: COLORS.bgHover, border: `1px solid ${COLORS.green3}55`,
                borderRadius: "7px", padding: "10px 16px", cursor: "pointer",
                color: COLORS.text, fontSize: "14px", fontFamily: "'Crimson Text', serif",
                textAlign: "left", transition: "background 0.15s, border-color 0.15s",
              }}
              onMouseEnter={e => { e.currentTarget.style.background = COLORS.green3 + "22"; e.currentTarget.style.borderColor = COLORS.green3; }}
              onMouseLeave={e => { e.currentTarget.style.background = COLORS.bgHover; e.currentTarget.style.borderColor = COLORS.green3 + "55"; }}
            >
              {name}
            </button>
          ))}
        ...
        <button onClick={onSkip}
          style={{
            ...
            color: COLORS.textDim, fontSize: "12px", fontFamily: "'Cinzel', serif",
            letterSpacing: "1px",
          }}
        >
          Add without enchanting
        </button>
      </div>
    </div>
  );
              ...
              <div key={deck.id} style={{
                ...
                {confirmDeleteDeck === deck.id ? (
                  <div style={{ display: "flex", gap: "4px", flexShrink: 0 }}>
                    <button onClick={(e) => { e.stopPropagation(); deleteDeck(deck.id); setConfirmDeleteDeck(null); }} style={{ background: "#3a0a0a", border: "1px solid #e74c3c44", borderRadius: "4px", color: "#e74c3c", cursor: "pointer", fontSize: "11px", padding: "3px 8px" }}>Delete</button>
                    <button onClick={(e) => { e.stopPropagation(); setConfirmDeleteDeck(null); }} style={{ background: "none", border: `1px solid ${COLORS.border}`, borderRadius: "4px", color: COLORS.textDim, cursor: "pointer", fontSize: "11px", padding: "3px 8px" }}>Cancel</button>
                  </div>
                ) : (
                  <button onClick={(e) => { e.stopPropagation(); setConfirmDeleteDeck(deck.id); }} style={{ background: "none", border: `1px solid #5a1a1a`, borderRadius: "4px", padding: "3px 8px", color: "#e74c3c88", cursor: "pointer", fontSize: "11px" }}>✕</button>
                )}
              </div>
            )})}
          </div>
...
function HelpModal({ onClose, onStartTour }) {
  ...
  const content = {
    ...
    rulings: (() => {
      const Rule = ({ id, children }) => (
        <div style={{ marginBottom: "8px" }}>
          <span style={{ color: COLORS.textDim, fontFamily: "monospace", fontSize: "11px", marginRight: "8px" }}>{id}</span>
          <span style={{ color: COLORS.text, fontSize: "13px", fontFamily: "'Crimson Text', serif", lineHeight: "1.6" }}>{children}</span>
        </div>
      );
      const RulingBox = ({ title, children }) => (
        <div style={{ background: "#0a1a0a", border: `1px solid ${COLORS.border}`, borderRadius: "8px", padding: "16px", marginBottom: "20px" }}>
          <div style={{ fontFamily: "'Cinzel', serif", fontSize: "12px", color: COLORS.gold, letterSpacing: "1px", marginBottom: "14px" }}>{title}</div>
          {children}
        </div>
      );
      const Note = ({ children }) => (
        <div style={{ background: "#0d200d", border: `1px solid ${COLORS.green1}44`, borderRadius: "6px", padding: "10px 14px", marginTop: "12px", fontSize: "13px", color: COLORS.text, fontFamily: "'Crimson Text', serif", lineHeight: "1.7" }}>
          {children}
        </div>
      );
      return (
        <>
          <H>RULES RULINGS</H>
          <P>Edge-case rules clarifications relevant to this deck.</P>

          <RulingBox title="DISCARD YEVA AT END STEP — CLEANUP STEP RULING">
            <P style={{ marginBottom: "14px" }}>Two things cause priority to be passed at the beginning of a cleanup step: abilities triggering, or state-based actions being performed.</P>
            <Rule id="514.1">First, if the active player's hand contains more cards than their maximum hand size (normally seven), they discard enough cards to reduce their hand size to that number. This turn-based action doesn't use the stack.</Rule>
            <Rule id="514.2">Second, the following actions happen simultaneously: all damage marked on permanents (including phased-out permanents) is removed and all "until end of turn" and "this turn" effects end. This turn-based action doesn't use the stack.</Rule>
            <Rule id="514.3">Normally, no player receives priority during the cleanup step, so no spells can be cast and no abilities can be activated. However, this rule is subject to the following exception:</Rule>
            <Rule id="514.3a">At this point, the game checks to see if any state-based actions would be performed and/or any triggered abilities are waiting to be put onto the stack (including those that trigger "at the beginning of the next cleanup step"). If so, those state-based actions are performed, then those triggered abilities are put on the stack, then the active player gets priority. Players may cast spells and activate abilities. Once the stack is empty and all players pass in succession, another cleanup step begins.</Rule>
            <Note>
              <strong>In order:</strong> you discard your commander (e.g. Yeva), the effect from Angel's Grace ends, you put your commander in the command zone as a state-based effect, and you receive priority.
              <br /><br />
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#000000dd", zIndex: 3000, display: "flex", alignItems: "center", justifyContent: "center", padding: "16px" }} onClick={onClose}>
      <div style={{ background: COLORS.bg, border: `1px solid ${COLORS.borderBright}`, borderRadius: "12px", width: "100%", maxWidth: "820px", maxHeight: "88vh", display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" }} onClick={e => e.stopPropagation()}>
...
// have been on the battlefield before the current turn to contribute to a loop.
// Built once at module load so the sim loop doesn't rebuild it every iteration.
const MUST_PRE_EXIST_CARDS = new Set(COMBOS.flatMap(c => c.mustPreExist ?? []));

// Tags that indicate a creature's contribution is entirely ETB-based or mana-tapping.
// Sick creatures with these tags are hidden from the advisor since they can't contribute yet.
const ETB_ONLY_TAGS = new Set(["dork","big-dork","etb","recursion","mana-doubler"]);

function isWinCategory(cat) {
  // Use exact substring matches to avoid "CAST FOR WIN NEXT TURN" matching "CAST FOR WIN"
  if (cat.includes("NEXT TURN")) return false;
...
function simulateOneGame(deckCards, deckSet, mullLimit = 2, maxTurns = 20) {
  ...
  // Lands that can produce green mana on T1 (or find one that can via fetch).
  // Excludes: Gaea's Cradle/Nykthos (0 mana T1), Ancient Tomb ({C}{C} only),
  // Shifting Woodland (needs a basic in play), Dryad Arbor (summoning sick T1).
  const GREEN_LANDS = new Set([
    "Forest",
    "Misty Rainforest","Verdant Catacombs","Windswept Heath","Wooded Foothills", // fetch → Forest
    "Yavimaya, Cradle of Growth", // always a Forest
    "Castle Garenbrig",           // taps for {G} or {G}{G}
    "Turntimber Symbiosis",       // land face taps for {G}
  ]);
  let mulligans = 0;
  ...
  let sickSet     = new Set(); // creatures that entered this turn (have summoning sickness)
  let winTurn     = null;
  let winCombo    = null;
  let bottlenecks = [];
  let manaCurve   = [];
  ...
  for (let turn = 1; turn <= MAX_TURNS; turn++) {
    ...
    if (simState.consumedAtEndOfTurn?.size > 0) {
      for (const c of simState.consumedAtEndOfTurn) {
        const idx = battlefield.indexOf(c);
        if (idx >= 0) { battlefield.splice(idx, 1); graveyard.push(c); }
      }
      simState.consumedAtEndOfTurn.clear();
    }
    if (turn > 1) {
    ...
    while (madePlay && turnsPlays < 20) {
      ...
      // Elvish Spirit Guide: exile from hand → add {G} (no mana cost, not a cast).
      // Do this eagerly when we need green mana for a 1-drop dork but have none from lands yet.
      {
      ...
      // Sick dorks can't tap for mana. Sick creatures with ETB-dependent roles
      // (recursion, draw, tutor) also can't contribute until next turn.
      // We hide sick dorks AND sick non-land creatures that entered this turn
      // but whose value is entirely ETB-based (Eternal Witness, Fierce Empath, etc.).
      // Quirion/Scryb Ranger and similar activated-ability creatures are kept
      // because their non-tap abilities work immediately.
      const advisorBattlefield = battlefield.filter(c => {
      ...
      if (top && isWinCategory(top.category)) {
        ...
        // All pieces must be on board already OR castable with our color-aware mana pool
        ...
        if (!activeCombo) {
          ...
          for (const req of activeCombo.requires) {
            ...
            // Piece must actually be in hand — pass-2 may have flagged it as "reachable" from library
            if (!hand.includes(req)) { winValid = false; break; }
            const data = getCard(req);
            if (!data || data.type === "land") continue;
            const cmc = data.cmc ?? 0;
            const pips = data.greenPips ?? Math.min(cmc, data.devotion ?? 0);
...
function simPlayCard(card, idx, simState, manaPool = null) {
  ...
  if (cardType === "instant" || cardType === "sorcery") {
    if (card === "Green Sun's Zenith") {
      ...
      // {G}: Untap all creatures you control. Key storm ritual — treated as a mana-neutral
      // spell in the sim. Its real effect (untapping tapped dorks) isn't directly modelled
      // in the mana pool (which already reads untapped creatures), but casting it is
      // meaningful as a signal. Goes to graveyard.
      graveyard.push(card);
    ...
    // by incrementing a one-shot mana counter, then goes to the graveyard.
    // Since sumManaPool reads from battlefield, we instead add Lotus Petal to the
    // battlefield briefly — it will be counted this turn — then mark it for consumption
    // at the end of the turn. We handle this by NOT pushing to battlefield at all,
    // and instead modelling its mana via a simState petal counter if present.
    // Simplest correct model: treat it as an instant that adds {G} by marking a flag
    // on simState so the mana calculation sees +1G for the rest of this turn.
    ...
    // and skip imprint entirely if no good target exists (Chrome Mox enters as {C} source).
    if (card === "Chrome Mox") {
      const imprintable = hand.reduce((acc, c, i) => {
        const cd = getCard(c);
        if (!cd || cd.type === "land") return acc;
        if ((cd.greenPips ?? 0) < 1 && (cd.devotion ?? 0) < 1) return acc; // not green
    ...
    if (card === "Fierce Empath") {
      ...
      const WB_PRIORITY = [
        ...
        "Elvish Archdruid", "Priest of Titania", "Circle of Dreams Druid",
        "Wirewood Channeler", "Marwyn, the Nurturer", "Selvala, Heart of the Wilds",
      ...
      for (const t of WB_PRIORITY) {
        const cd = getCard(t);
        if (!cd || cd.type !== "creature") continue;
        if (LEGENDARY.has(t)) continue; // can't fetch legendary
        if ((cd.cmc ?? 0) > 3) continue; // CMC ≤ 3
        if (boardSetWB.has(t)) continue;
        if (library.indexOf(t) !== -1) { wbTarget = t; break; }
      }
      if (!wbTarget) wbTarget = library.find(c => {
        const cd = getCard(c);
        return cd?.type === "creature" && (cd.cmc ?? 0) <= 3 &&
          !boardSetWB.has(c) && !LEGENDARY.has(c);
      }) ?? null;
      if (wbTarget) {
        library.splice(library.indexOf(wbTarget), 1);
        battlefield.push(wbTarget);
        sickSet.add(wbTarget);
        for (let i = library.length - 1; i > 0; i--) {
          const j = Math.floor(Math.random() * (i + 1));
          [library[i], library[j]] = [library[j], library[i]];
        }
...
// ── HandHoverPopup — shows full opening hand as card images on hover ──────────
function HandHoverPopup({ hand, anchorRef }) {
  ...
  return (
    <div style={{
      ...
      background: "#0d1a0d", border: `1px solid ${COLORS.borderBright}`,
      borderRadius: "8px", padding: "8px", boxShadow: "0 6px 28px rgba(0,0,0,0.9)",
      display: "flex", gap: "4px", flexWrap: "wrap", maxWidth: "360px",
      pointerEvents: "none",
    }}>
      {hand.map((name, i) => <MiniCardImg key={i} name={name} />)}
    </div>
  );
}

function MiniCardImg({ name }) {
  const url = useScryfallImage(name);
  return (
    <div style={{ width: 44, height: 62, borderRadius: "4px", overflow: "hidden",
      border: `1px solid ${COLORS.border}`, background: "#0a150a", flexShrink: 0 }}
      title={name}>
      {url && url !== "error"
        ? <img src={url} alt={name} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
        : <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: "7px", color: COLORS.textDim, fontFamily: "'Crimson Text',serif",
            textAlign: "center", padding: "3px", lineHeight: 1.2 }}>{name}</div>
      }
    </div>
  );
}

function OpeningHandCell({ hand }) {
  const [hovered, setHovered] = useState(false);
  const ref = useRef(null);
  return (
    <td style={{ padding: "5px 6px", color: COLORS.textDim, fontSize: "11px", maxWidth: "140px" }}>
      <span ref={ref}
        ...
        {(hand||[]).slice(0, 2).join(", ")}{(hand||[]).length > 2 ? ` +${(hand||[]).length - 2}` : ""}
      </span>
      {hovered && <HandHoverPopup hand={hand} anchorRef={ref} />}
    </td>
  );
}
...
function PlayfieldCardImg({ card, zone, tapped, counters, onClick, onContextMenu, size = "normal", dimmed = false, borderColor = null }) {
  const url = useScryfallImage(card);
  const [hovered, setHovered] = useState(false);
  ...
  return (
    <div
      ...
      onMouseEnter={() => { setPopupStyle(computePopupStyle()); setHovered(true); }}
      onMouseLeave={() => setHovered(false)}
      title={card}
      style={{
        position: "relative",
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: "6px", overflow: "hidden",
          border: `1px solid ${tapped ? COLORS.gold + "99" : borderColor ? borderColor : hovered ? COLORS.green2 + "aa" : COLORS.border}`,
          boxShadow: hovered
        ...
        {/* Transform badge — shown for DFCs on the battlefield */}
        {zone === "battlefield" && (getCard(card)?.transformsTo || getCard(card)?.transformsFrom) && (
          <div style={{
            position: "absolute", top: 3, right: 3,
            background: "#1a1000", color: COLORS.gold,
            borderRadius: "4px", padding: "1px 4px",
            fontSize: "9px", fontFamily: "'Cinzel', serif",
            border: `1px solid ${COLORS.gold}88`, pointerEvents: "none",
            transform: tapped ? "rotate(-90deg)" : "none",
          }}>⟳</div>
        )}
      </div>
...
function PlayfieldImageView({
  ...
  if (attachments) {
    for (const [auraIdx, landIdx] of attachments) {
      const aura = battlefield[auraIdx];
      if (!aura) continue;
      if (!landAuras.has(landIdx)) landAuras.set(landIdx, []);
      landAuras.get(landIdx).push({ c: aura, i: auraIdx });
    }
  }
  // Indices of enchant-land auras — excluded from bfOther since they render on their land
  const attachedAuraIndices = attachments ? new Set(attachments.keys()) : new Set();
  ...
  // Exclude attached enchant-land auras from OTHER row — they render stacked on their land
  const bfOther     = battlefield.map((c, i) => ({ c, i })).filter(({ c, i }) =>
    !["land", "creature"].includes(getCard(c)?.type) && !attachedAuraIndices.has(i)
  );
          ...
          : cards.map(({ c, i }) => {
              ...
              return (
                <PlayfieldCardImg
                  ...
                  dimmed={isGrave || (isHand && unplayable)}
                  size={isHand ? "hand" : "normal"}
                  borderColor={isHand && cantAfford ? COLORS.red + "99" : null}
                  onClick={isBf ? () => onBattlefieldClick(c, i) : isHand && !unplayable ? () => onHandClick(c, i) : undefined}
    ...
    <div style={{ padding: "10px 12px" }}>
      ...
      <div style={{ marginBottom: "12px" }}>
        ...
        >
          ...
          {/* Lands — bottom row, with attached auras stacked on top */}
          {bfLands.length > 0 && (
            <div>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "4px", alignItems: "flex-end" }}>
                {bfLands.map(({ c, i }) => {
                  ...
                  const attachedAuras = landAuras.get(i) || [];
                  // Card dimensions (must match PlayfieldCardImg size="normal": W=76)
                  const W = 76, H = Math.round(76 * 1.396); // ~106px
                  const outerW = isTapped ? H : W;
                  const outerH = isTapped ? W : H;
                  // Each aura stacks offset down-right so both cards are visible
                  const AURA_SCALE = 0.72;
                  const AW = Math.round(W * AURA_SCALE);
                  const AH = Math.round(H * AURA_SCALE);
                  const OFFSET = 10; // px offset per aura layer
                  // Total container needs extra room for stacked auras
                  const stackExtra = attachedAuras.length * OFFSET;
                  return (
                    <div
                      key={`land-stack:${c}:${i}`}
                      style={{
                        position: "relative",
                        width: outerW + (attachedAuras.length > 0 ? stackExtra : 0),
                        height: outerH + (attachedAuras.length > 0 ? stackExtra : 0),
                        flexShrink: 0,
                      }}
                    >
                      {/* Base land card */}
                      <div style={{ position: "absolute", top: 0, left: 0 }}>
                        <PlayfieldCardImg
                          card={c} zone="battlefield"
                          tapped={isTapped} counters={counters[key] ?? 0}
                          onClick={() => onBattlefieldClick(c, i)}
                          onContextMenu={e => onContextMenu(c, i, "battlefield", e)}
                        />
                      </div>
                      {/* Stacked aura overlays */}
                      {attachedAuras.map(({ c: aura, i: auraIdx }, layer) => {
                        const auraKey = cardKey(aura, auraIdx);
                        return (
                          <div
                            key={`aura:${aura}:${auraIdx}`}
                            style={{
                              position: "absolute",
                              top: OFFSET * (layer + 1),
                              left: OFFSET * (layer + 1),
                              ...
                              outline: `1.5px solid ${COLORS.green3}66`,
                            }}
                          >
                            <PlayfieldCardImg
                              card={aura} zone="battlefield"
                              tapped={false} counters={counters[auraKey] ?? 0}
                              size="small"
                              onClick={() => onBattlefieldClick(aura, auraIdx)}
                              onContextMenu={e => onContextMenu(aura, auraIdx, "battlefield", e)}
                            />
                          </div>
                        );
                      })}
...
function GoldfishModal({ activeDeck, onClose, onLoadState }) {
  ...
  const untappedAttachments = (() => {
    // Build a map from original index → new index in untappedBattlefield
    const idxMap = new Map();
    let newIdx = 0;
    for (let i = 0; i < battlefield.length; i++) {
      if (!tapped.has(`${battlefield[i]}:${i}`)) { idxMap.set(i, newIdx); newIdx++; }
    }
    const m = new Map();
    for (const [auraI, landI] of attachments) {
      const newAuraI = idxMap.get(auraI);
      const newLandI = idxMap.get(landI);
      // Only include if both the aura AND the land are untapped
      if (newAuraI != null && newLandI != null) m.set(newAuraI, newLandI);
    }
    return m;
  })();
  ...
  function keepHand() {
    ...
    setPhase("playing");
    // Draw a card at the start of T1 (in Goldfish you always draw on your first turn)
    const drawn = library[0];
    if (drawn) {
      setLibrary(prev => prev.slice(1));
      setHand(prev => [...prev, drawn]);
      addLog(`Kept ${hand.length}-card hand. Turn 1 begins — drew ${drawn}.`, COLORS.green1);
    } else {
  ...
  function nextTurn() {
    ...
    // Auto-transform Growing Rites of Itlimoc → Itlimoc if ≥4 creatures on battlefield
    // (trigger fires at end of turn / beginning of end step with ≥4 creatures you control)
    setBattlefield(prev => {
      const creaturesNow = prev.filter(c => getCard(c)?.type === "creature").length;
      if (prev.includes("Growing Rites of Itlimoc") && creaturesNow >= 4) {
        const idx = prev.indexOf("Growing Rites of Itlimoc");
        const next = [...prev];
        next[idx] = "Itlimoc, Cradle of the Sun";
        addLog("Growing Rites of Itlimoc → Itlimoc, Cradle of the Sun (auto-transformed: ≥4 creatures).", COLORS.gold);
        // Migrate tap state
        setTapped(t => {
          const s = new Set(t);
          const oldKey = `Growing Rites of Itlimoc:${idx}`;
          const newKey = `Itlimoc, Cradle of the Sun:${idx}`;
  ...
  function goldfishConfirmAura(auraName, landIdx) {
    const auraIdx = battlefield.length; // aura appends at end
    setBattlefield(prev => [...prev, auraName]);
    setAttachments(att => { const m = new Map(att); m.set(auraIdx, landIdx); return m; });
    setPendingAura(null);
  }
  ...
  // ── TAP / UNTAP ─────────────────────────────────────────────
  // Mana produced by a single permanent at battlefield[idx], accounting for attachments.
  // Returns a flat total (green + colorless) for the mana pool integer.
  ...
  function castFromHand(card, idx) {
    ...
    if (type === "land") {
      ...
      if (card === "Green Sun's Zenith") {
        ...
        if (gszX === 0) {
          // T1 with 1 mana: X=0 → auto-tutor Dryad Arbor
        ...
        setTutorOnSelect(() => (chosen) => {
          ...
          addLog(`Sylvan Scrying → ${chosen} → hand. Library shuffled.`, COLORS.purple);
        });
        setShowTutor(true); setTutorQuery("");
        setTimeout(() => tutorInputRef.current?.focus(), 50);
  ...
  // ── TUTOR ───────────────────────────────────────────────────
  function openTutor() { setShowTutor(true); setTutorQuery(""); setTutorMaxCmc(null); setTutorOnSelect(null); setTutorSelected(0); setTimeout(() => tutorInputRef.current?.focus(), 50); }
  ...
  // ── TRANSFORM CARD ───────────────────────────────────────────
  // Swaps a DFC between its two faces in-place, preserving tap/counter state.
  function transformCard(card, index) {
    const data = getCard(card);
    const targetName = data?.transformsTo ?? data?.transformsFrom;
    if (!targetName) return;
    pushUndo();
    setBattlefield(prev => {
      const next = [...prev];
      next[index] = targetName;
      return next;
    });
    // Migrate tap/counter state from old key to new key
    const oldKey = cardKey(card, index);
    const newKey = cardKey(targetName, index);
    setTapped(prev => {
      const next = new Set(prev);
    ...
    const dir = data?.transformsTo ? "→" : "↩";
    addLog(`${card} ${dir} ${targetName} (transformed).`, COLORS.gold);
    closeContextMenu();
  }
  ...
  function moveCard(card, fromZone, toZone, fromIndex) {
    ...
    if (fromZone === "hand") removeFn(setHand, hand);
      ...
      goldfishRemoveFromBattlefield(card, fromIndex ?? battlefield.indexOf(card));
    ...
    if (toZone === "hand") setHand(prev => [...prev, card]);
      ...
      goldfishAddToBattlefield(card); // handles sickness marking internally
    }
    else if (toZone === "graveyard") setGraveyard(prev => [...prev, card]);
    else if (toZone === "exile") {
      setExile(prev => [...prev, card]);
      // Elvish Spirit Guide: exile from hand adds {G} immediately (its only ability)
      if (card === "Elvish Spirit Guide" && fromZone === "hand") {
        setManaPool(prev => prev + 1);
        flashMana(1);
        addLog(`Exile Elvish Spirit Guide → +{G} added to mana pool.`, COLORS.green2);
      } else {
        addLog(`${card} exiled.`, COLORS.textDim);
      }
      closeContextMenu(); return;
    }
  ...
  function runGames(e) {
    ...
    setTimeout(() => {
      try {
        const results = runNGames(deckCards, count, runNMaxTurns);
        ...
        {(rect, hovered) => (
          <span
            ...
            {(getCard(card)?.transformsTo || getCard(card)?.transformsFrom) && zone === "battlefield" && (
              <span style={{ fontSize: "9px", color: COLORS.gold }}>⟳</span>
            )}
  ...
  const ContextMenuPopup = () => {
    ...
    return (
      <div onClick={e => e.stopPropagation()} onMouseDown={e => e.stopPropagation()} style={{
        ...
        {/* Transform (DFC) */}
        {isBF && (getCard(card)?.transformsTo || getCard(card)?.transformsFrom) && (
          <div onClick={() => transformCard(card, index)} style={{ padding: "6px 14px", cursor: "pointer", color: COLORS.gold, letterSpacing: "1px" }}
        ...
        {isBF && (card === "Survival of the Fittest" || card === "Fauna Shaman") && (() => {
          ...
          if (handCreatures.length === 0 || isCardTapped) return (
  ...
  const TutorOverlay = () => {
    ...
    return (
      <div style={{
        ...
        zIndex: 1500, width: "min(420px, 90vw)", maxHeight: "80vh", overflowY: "auto",
        ...
        {hint && defaults.length > 0 && q.length === 0 && (
        ...
        {displayList.length === 0 && (q.length >= 1 || isGSZ || isCreature || isLand || isTreefolk) && (
          <div style={{ fontSize: "11px", color: COLORS.textDim, fontStyle: "italic", fontFamily: "'Crimson Text', serif" }}>
            {emptyMsg}
          </div>
        )}
        {displayList.map((card, i) => (
          <div key={i} onClick={() => tutorCard(card)} onMouseEnter={() => setTutorSelected(i)}
            style={{ padding: "6px 10px", cursor: "pointer", borderRadius: "4px", fontSize: "12px",
              fontFamily: "'Crimson Text', serif", marginBottom: "2px",
              background: i === tutorSelected ? "#1a3a1a" : "transparent",
              color: i === tutorSelected ? COLORS.green2 : COLORS.textMid,
            }}>
            {card}
            {getCard(card) && (
        ...
        <button onClick={closeTutor} style={{
  ...
  return (
    ...
    {pendingAura && (
      <AuraTargetModal
        auraName={pendingAura.name}
        lands={pendingAura.lands}
        onConfirm={(landIdx) => goldfishConfirmAura(pendingAura.name, landIdx)}
            ...
            <div style={{
              ...
              <div style={{ padding: "5px 12px", borderBottom: `1px solid ${COLORS.border}`, display: "flex", gap: "8px", alignItems: "center" }}>
                {(() => {
                  ...
                  return (
                    <span style={{ fontSize: "10px", color: landAvailColor, fontFamily: "'Cinzel', serif", letterSpacing: "1px", opacity: (!landPlayed && !hasLandInHand) ? 0.45 : 1 }}>
              ...
              <div style={{ flex: 1, overflowY: "auto", padding: viewMode === "image" ? "0" : "12px 14px" }}>
                {viewMode === "image" ? (
                  <PlayfieldImageView
                    ...
                    onBattlefieldClick={(c, i) => {
                      if (isFetch(c)) { crackFetch(c, "battlefield"); }
                      else { toggleTap(c, i); }
                    }}
                    ...
                    {hand.length === 0
                      ...
                      : hand.map((card, i) => {
                          ...
                          return renderCard(card, i, "hand", {
                            ...
                            style: {
                              cursor: unplayable ? "not-allowed" : "pointer",
                              opacity: unplayable ? 0.45 : 1,
                              borderColor: cantAfford ? COLORS.red + "99"
                                         : isLand     ? "#3a5a2a"
                                         : isFetch(card) ? COLORS.blue + "88"
                                         : COLORS.border,
                                ...
                                <div>
                                  {g.cards.map(({c, i}) => {
                                    ...
                                    return renderCard(c, i, "battlefield", {
                                      ...
                                      onClick: () => isFetch(c) ? crackFetch(c, "battlefield") : toggleTap(c, i),
                ...
                {(hand.length + battlefield.length === 0) ? (
                  ...
                  analysis.results.slice(0, 12).map((a, i) => (
                    <div key={i} style={{
                      ...
                      borderLeft: `3px solid ${a.isSuppressed ? "#3a3a3a" : a.color || COLORS.green1}`,
                ...
                <div style={{ width: "340px", flexShrink: 0, display: "flex", flexDirection: "column", overflow: "hidden" }}>
                  ...
                  <div style={{ padding: "14px 18px", borderBottom: `1px solid ${COLORS.border}`, flexShrink: 0 }}>
                    ...
                    <button
                      ...
                      title={`Click to run ${runNCount} games. Shift+Click to run ${runNCount * 10} games.`}
                      style={{
                    ...
                    {nr && !runNRunning && (() => {
                      ...
                      return (
                        <div>
                          ...
                          {/* ── Section E: Fastest Wins ── */}
                          {(() => {
                            const fastWins = [...(nr.results||[])]
                              .filter(r => r.winTurn !== null)
                              .sort((a, b) => a.winTurn - b.winTurn)
                              .slice(0, 3);
                            if (!fastWins.length) return null;
                            return (
                              <div style={{ marginTop: "14px" }}>
                                <div style={{ fontFamily: "'Cinzel', serif", fontSize: "9px", color: COLORS.gold, letterSpacing: "1px", marginBottom: "8px" }}>
                                  ⚡ FASTEST WINS
                                </div>
                                {fastWins.map((r, i) => (
                                  <div key={i} style={{
                                    marginBottom: "10px", padding: "8px 10px",
                                    background: "#0a150a", borderRadius: "6px",
                                    border: `1px solid ${i === 0 ? COLORS.gold + "66" : COLORS.border}`,
                                  }}>
                                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "6px", alignItems: "center" }}>
                                      <span style={{ fontFamily: "'Cinzel', serif", fontSize: "9px", color: i === 0 ? COLORS.gold : COLORS.green2, letterSpacing: "1px" }}>
                                        {i === 0 ? "★ " : ""}T{r.winTurn} WIN
                                        {r.mulligans > 0 && <span style={{ color: COLORS.textDim, marginLeft: "6px" }}>{r.mulligans} mull</span>}
                                      </span>
                                      <span style={{ fontSize: "9px", color: COLORS.textDim, fontFamily: "'Crimson Text', serif", fontStyle: "italic" }}>
                                        {r.winCombo || ""}
                                      </span>
                                    </div>
                                    <div style={{ display: "flex", gap: "3px", flexWrap: "wrap" }}>
                                      {(r.openingHand||[]).map((name, j) => (
                                        <MiniCardImg key={j} name={name} />
                                      ))}
                                    </div>
                                  </div>
                                ))}
...
function YevaAdvisor() {
  ...
  const [pendingAura, setPendingAura] = useState(null);
  ...
  useEffect(() => {
    ...
    decompressState(encoded).then(state => {
      ...
      if (state.mana != null && state.greenMana == null) setGreenMana(String(state.mana));
  ...
  // addCardToBattlefield: internal — adds the card then optionally attaches it.
  // If landIndex is provided (enchant-land aura), records the attachment.
  const addCardToBattlefield = (card, landIndex = null) => {
    const isBasic = getCard(card)?.tags?.includes("basic");
    if (!isBasic) {
      setHand(prev => { const i = prev.indexOf(card); return i === -1 ? prev : [...prev.slice(0,i), ...prev.slice(i+1)]; });
      setGraveyard(prev => { const i = prev.indexOf(card); return i === -1 ? prev : [...prev.slice(0,i), ...prev.slice(i+1)]; });
    }
    // setBattlefield and setAttachments must be separate calls — never call one setter
    // inside another setter's updater function (React side-effect rule).
    setBattlefield(prev => (!isBasic && prev.includes(card)) ? prev : [...prev, card]);
    if (landIndex !== null) {
      // The aura will land at index = current battlefield length (or length-1 if deduped,
      // but enchant-land auras are never basics so they always append).
      const auraIdx = battlefield.length; // captured from closure; safe — dedup can't fire for auras
      setAttachments(att => { const m = new Map(att); m.set(auraIdx, landIndex); return m; });
    }
  };
  ...
  const addTo = (zone) => (card) => {
    if (zone === "battlefield") {
      ...
      if (isEnchantLand) {
        ...
        if (lands.length > 0) {
          setPendingAura({ name: card, lands });
          return; // modal will call addCardToBattlefield when target is chosen
        }
        // No valid land targets — add without attachment
        addCardToBattlefield(card);
        return;
      }
    }
    const isBasic = getCard(card)?.tags?.includes("basic");
  ...
  // removeFromBattlefield: removes card AND cleans up any attachment involving it.
  // Two separate setState calls — never nest setAttachments inside setBattlefield's updater.
  const removeFromBattlefield = (card) => {
    const idx = battlefield.indexOf(card);
    if (idx === -1) return;
    setBattlefield(prev => {
    ...
    setAttachments(att => {
      const m = new Map();
      for (const [auraI, landI] of att) {
        if (auraI === idx || landI === idx) continue; // card being removed
        const newAuraI = auraI > idx ? auraI - 1 : auraI;
        const newLandI = landI > idx ? landI - 1 : landI;
        m.set(newAuraI, newLandI);
      }
      return m;
    });
  ...
  const removeFrom = (setter) => (card) => {
    if (setter === setBattlefield) { removeFromBattlefield(card); return; }
    setter(prev => {
  ...
  // Auto-calculate mana from battlefield contents (attachment-aware)
  useEffect(() => {
    const pool = calculateBattlefieldMana(battlefield, null, attachments);
    setGreenMana(String(pool.green));
    setColorlessMana(String(pool.colorless));
        ...
        <div style={{
          ...
          {pendingAura && (
            <AuraTargetModal
              ...
              lands={pendingAura.lands}
              onConfirm={(landIdx) => {
                addCardToBattlefield(pendingAura.name, landIdx);
                setPendingAura(null);
              }}
              onSkip={() => {
                addCardToBattlefield(pendingAura.name);
                setPendingAura(null);
              }}
            />
          )}
          ...
          {showSavedStates && (
            <SavedStatesPanel
              ...
              onLoad={(s) => {
                ...
                if (s.attachments) setAttachments(new Map(s.attachments)); // restore aura targets
              }}
            ...
            <div style={{
              ...
              <div style={{
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    <button onClick={() => {
                      const dump = {
                        ...
                        greenMana: parseInt(greenMana) || 0, colorlessMana: parseInt(colorlessMana) || 0,
                        hand, battlefield, graveyard,
                ...
                {[
                  ...
                  { label: "MANA",    value: `${greenMana}G / ${colorlessMana}C` },
                ].map(({ label, value }) => (
